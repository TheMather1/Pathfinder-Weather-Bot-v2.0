...
enum class Climate(
    ...
    TEMPERATE(
        ...
        override fun tempWave(start: LocalDate) = when (1 d 100) {
            ...
            in 36..65 -> tempWave(start, (1 d 6) + 1) { 0L }
    ...
    TROPICAL(
        ...
        override fun tempWave(start: LocalDate) = when (1 d 100) {
            ...
            in 26..55 -> tempWave(start, 1 d 4) { 0L }
    ...
    protected fun tempWave(start: LocalDate, days: Long, function: () -> Long) =
        TemperatureWave(this, start.plusDays(days), function)
}